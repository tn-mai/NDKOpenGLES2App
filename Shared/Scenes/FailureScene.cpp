  ...
  */
  ...
  bool FailureScene::Load(Engine& engine) {
...

	{
	  ...
	  o0.SetTranslation(Vector3F(1, 0.75f, -1));
	  ...
	  o2.SetTranslation(Vector3F(-12.5f, 0.75f, -2.5));
	  objList.push_back(obj2);

	  auto obj1 = r.CreateObject("EggWhite", Material(Color4B(255, 255, 255, 64), -0.25f, 0), "defaultWithAlpha");
	  Object& o1 = *obj1;
	  o1.SetScale(Vector3F(3, 3, 3));
	  o1.SetTranslation(Vector3F(-12, 1, 0));
